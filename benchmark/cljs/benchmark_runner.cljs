...
(println "\n")
(println ";; cycle")
(simple-benchmark [] (doall (take 1000 (cycle [1 2 3]))) 10000)
(simple-benchmark [] (into [] (take 1000) (cycle [1 2 3])) 10000)
...
(println "\n")
(println ";; iterate")
(simple-benchmark [] (doall (take 1000 (iterate inc 0))) 10000)
(simple-benchmark [] (into [] (take 1000) (iterate inc 0)) 10000)
